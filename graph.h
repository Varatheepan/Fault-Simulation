...
#define x 2           //don't care value
#define D 3           //D value
#define DB 4          //D bar value

// FAULT 
#define Mfln 10   //Maximum length of a fault representation line
...
{
  int Pattern[Mpi];                     //Simulation input pattern
} PATTERN;
...
****************************************************************************************************************************/
void getNum_PInputs_POutputs(NODE *, int , int *, int *);
void ReadVec(FILE *,int);
// int ReadVecArr(FILE *,int , int);
int ReadVecArr(FILE *,int, PATTERN *);
// int getNumVec(FILE *);
// void logicSimulation(NODE *, int, int, PATTERN *, char *);
void logicSimulation(NODE *, int, int, PATTERN *, char *, int, FAULT *,int *);
